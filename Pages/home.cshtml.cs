...
namespace appPrototype_FFC.Pages
{
    public class IndexModel : PageModel
    {
        ...
        public List<FilmItem> FavoriteFilms { get; set; }
        ...
        Films.Add(new FilmItem
            ...
            FavoriteFilms = new List<FilmItem>
        {
            new FilmItem { Title = "The Shawshank Redemption", Year = 1994, Rating = 9 },
            new FilmItem { Title = "The Godfather", Year = 1972, Rating = 8 }
        };
